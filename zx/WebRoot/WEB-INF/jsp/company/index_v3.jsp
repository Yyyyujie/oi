...
<body class="gray-bg">
    ...
    <!-- Flot -->
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/flot/jquery.flot.js"></script>
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/flot/jquery.flot.symbol.js"></script>

    <!-- Peity -->
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/peity/jquery.peity.min.js"></script>
    <script src="${pageContext.request.contextPath }/statics/
    js/demo/peity-demo.js"></script>
    ...
    <!-- Jvectormap -->
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- EayPIE -->
    <script src="${pageContext.request.contextPath }/statics/
    js/plugins/easypiechart/jquery.easypiechart.js"></script>
    ...
    <!-- Sparkline demo data  -->
    <script src="${pageContext.request.contextPath }/statics/
    js/demo/sparkline-demo.js"></script>
