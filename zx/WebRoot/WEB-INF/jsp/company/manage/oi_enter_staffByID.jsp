...
<main style="top:0">
    ...
    <div class="person">
    	<c:if test="${staff.face !=null && staff.face!='' }">
    	 	<div class="person-head" style="background:url(http://oi.sxfs0351.com/${staff.face}) center no-repeat;background-size: contain;"></div>
			 </c:if>
			<c:if test="${staff.face==null || staff.face=='' }">
			<div class="person-head" style="background:url(${staff.header}) center no-repeat;background-size: contain;"></div>
			</c:if>
        ...
        <div class="person-message">
            ...
            <li>电&nbsp;&nbsp;&nbsp;话：<span class="phone">${staff.phone }</span> </li>
