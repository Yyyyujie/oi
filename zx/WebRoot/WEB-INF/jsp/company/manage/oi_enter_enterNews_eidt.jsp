			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form id="submit" action="<%=basePath%>/company/news/edit.html"
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="title" value="${news.title }"
										class="form-control" placeholder="请填写新闻标题" />
								</div>
							</div>
							<!--水平线-->
							...
							<div class="form-group">
								...
								<div class="col-sm-8 box">
									<input type="hidden" value="${company_id }" id="company">
									<select class="form-control" id="dept">
										<option value="0">请选择部门</option>
									</select> 
									<input type="hidden" id="user_id" value="${news.user_id }">
									<select class="form-control" name="user_id" id="user">
										<option value="0">请选择个人</option>
									</select>
								</div>
							</div>
							<!--水平线-->
							...
							<div class="form-group">
								...
								<div class="col-sm-8 box">
									<input type="hidden" id="type_id" value="${news.type_id }">
			...
			$("#dept")
					.change(
							function() {
								...
								$
										.ajax({
											url : "${pageContext.request.contextPath}/Admin/getstaffer/"
													+ dept_id
													+ "/"
													+ company_id,
											type : "GET",
											...
											success : function(result) {
												...
												if (staffer.length != 0) {
													...
													$("#user")
															.html(
																	"<option value='0'>该部门下暂无员工</option>")
												}
