...
<body class="gray-bg">
		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title clearfix">
					<span class="btn btn-link">企业类型</span>
					<div class="ibox-tools clearfix">
						...
						<a style="color:#fff;" class="btn btn-info text-default"
							href="javascript:location.reload(true);" id="refreshBtn">刷新</a> <a
				...
				<div class="ibox-content">
					<!--树形图显示部分-->
					<div class="col-sm-6">
						<div id="oi_admin_typeTree" class="test ztree"></div>
					</div>
					<!--树形图显示部分 - 结束-->
	...
	<script
		src="${pageContext.request.contextPath}/statics/js/demo/oi_admin_enter_tree.js"></script>
