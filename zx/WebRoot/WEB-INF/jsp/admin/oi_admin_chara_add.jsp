...
<body class="gray-bg">
				...
				<div class="ibox-title clearfix">
					...
					<div class="ibox-tools clearfix">
						...
						<a style="color:#fff;" class="btn btn-info text-default"
							href="javascript:location.href=''" id="refreshBtn">刷新</a>
					</div>
				</div>
	...
	<script
		src="${pageContext.request.contextPath}/statics/js/demo/oi_admin_enter_tree3.js"></script>
