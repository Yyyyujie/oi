...
<head>
 ...
 <style>
    ...
    #oi_enter_news_01 td, #oi_enter_news_01 td *{
      overflow: hidden!important;
      text-overflow: ellipsis!important;
      word-break: keep-all!important;
      white-space: nowrap!important;
      font:normal 13px/1.5 "Microsoft Yahei",Arial,sans-serif!important;
      color:#333!important;
    }
  </style>
                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                <button data-target="oi_enter_news_Type" type="button" class="table_tool_add btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                </button>
                                <button data-target="oi_enter_news_Type" type="button" class="table_tool_delete btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-trash" aria-hidden="true"></i>
                                </button>
                            </div>
                            <table id="oi_enter_news_Type" data-height="400" data-mobile-responsive="true">
