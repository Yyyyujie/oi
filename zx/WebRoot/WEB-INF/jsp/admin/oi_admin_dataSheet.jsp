...
<body class="gray-bg">
	...
	<!-- ECharts -->
	<script
		src="${pageContext.request.contextPath}/statics/js/plugins/echarts/echarts-all.js"></script>
	<!-- 自定义js -->
	<script
		src="${pageContext.request.contextPath}/statics/js/content.js?v=1.0.0"></script>
	<!-- ECharts demo data -->
	<script
		src="${pageContext.request.contextPath}/statics/js/demo/echarts-demo.js"></script>
</body>
</html>
